  ...
  return (
    <div className="fixed inset-0 bg-bg/70 z-50 flex items-center justify-center" onClick={onClose}>
      <motion.div
        ...
        className="bg-surface p-6 rounded-xl border border-border w-full max-w-sm text-text"
      ...
      >
        ...
        <div className="mb-4"><ReCAPTCHA theme="dark" sitekey="6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI" onChange={setCaptcha} /></div>
