        ...
        <div className={`flex justify-center items-center h-28 w-full ${isMine ? '-mt-2' : '-mt-8'}`}>
          {isMine ? (
            ...
            (() => {
              ...
              return (
                <div className="relative" style={{ width }}>
                  {/* мини-веер рубашек наполовину под аватаркой — redesigned */}
                  <div className="absolute -top-8 left-1/2 -translate-x-1/2 opponent-fan">
          ...
          <div className="battlefield">
            <AnimatePresence>
              {gameState.table.map((pair) => (
                <motion.div
                  key={pair.attack.id}
                  className="relative w-24 h-32 md:w-28 md:h-40"
                ...
                >
                  ...
                  {pair.defense && (
                    <Card
                      ...
                      className="absolute left-10 top-6 md:left-12 md:top-9 rotate-[16deg] z-10 card-on-top"
                    />
                  )}
                </motion.div>
              ))}
